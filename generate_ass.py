...
STYLES = {
    "A": {
        # "Bold Impact" — Bebas Neue, uppercase, contorno negro sutil, keywords en verde
        "font":             "Bebas Neue",
        "font_fallback":    "Arial",
        "font_size":        120,
        "kw_font_size":     120,
        "max_words":        4,
        "case":             "upper",
        "primary_color":    "&H00E3DDD4",   # crema beige (#D4DDE3 → ASS BGR)
        "kw_color":         "&H008C9846",   # verde oliva (#46988C → ASS BGR)
        "secondary_color":  "&H00E3DDD4",
    ...
    "B": {
        # "Boxed Highlight" — texto blanco, keyword en caja verde sólida con texto oscuro
        "font":             "Bebas Neue",
        "font_fallback":    "Arial",
        "font_size":        120,
        "kw_font_size":     120,
        "max_words":        4,
        "case":             "upper",
        "primary_color":    "&H00DFD9CF",   # blanco crema (#CFD9DF → ASS BGR)
        "kw_color":         "&H00171807",   # texto oscuro sobre caja (#071817 → ASS BGR)
        "secondary_color":  "&H00DFD9CF",
        "outline_color":    "&H00000000",   # negro
        "back_color":       "&HAA000000",   # caja negra semitransparente para texto normal
        "kw_back_color":    "&H008B9A3D",   # caja verde para keywords (#3D9A8B → ASS BGR)
        "bold":             1,
        "kw_bold":          1,
        "italic":           0,
        "underline":        0,
