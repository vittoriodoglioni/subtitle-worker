...
STYLES = {
    "A": {
        # "Bold Impact" — Bebas Neue, uppercase, shadow
        "font":             "Bebas Neue",
        "font_fallback":    "Arial",
        "font_size":        72,
        "kw_font_size":     80,
    ...
    "B": {
        # "Boxed Highlight" — Bebas Neue, caja semitransparente
        "font":             "Bebas Neue",
        "font_fallback":    "Arial",
        "font_size":        64,
        "kw_font_size":     64,
        ...
        "kw_color":         "&H0014171A",   # obsidian (dark text on green box)
        "secondary_color":  "&H00D4E0E8",
        "outline_color":    "&H00090B0D",
        "back_color":       "&HCC090B0D",   # deep con 80% opacidad (alpha CC=204)
    ...
    "C": {
        # "Minimal Accent" — Outfit, sentence case, warm accent
        "font":             "Outfit",
        "font_fallback":    "Arial",
        "font_size":        56,
        "kw_font_size":     62,
