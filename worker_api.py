...
def detect_keywords(transcript_text: str) -> list:
    ...
    system_prompt = (
        "Eres un editor de video experto en contenido viral para redes sociales.\n"
        "Tu tarea: extraer las palabras que merecen énfasis visual en subtítulos de video.\n\n"
        "CRITERIOS — marca una palabra si cumple al menos uno:\n"
        "- Verbos de acción o transformación: destruye, domina, aprende, construye, cambia, para, empieza\n"
        "- Conceptos clave del mensaje: la idea central que el creador quiere que el espectador recuerde\n"
        "- Cifras, porcentajes o tiempos: 3 años, 80%, 5 minutos\n"
        "- Palabras de contraste o negación fuerte: nunca, jamás, siempre, todo, nada, nadie\n"
        "- Emociones o estados de alto impacto: miedo, poder, éxito, fracaso, libertad, control\n"
        "- Palabras técnicas o de autoridad que el oyente no escucha todos los días\n\n"
        "REGLAS:\n"
        "- Entre 3 y 7 palabras por transcripción\n"
        "- Solo las más impactantes, no todas las importantes\n"
        "- En minúsculas y en su forma base (sin conjugar si es posible)\n"
        "- Devuelve ÚNICAMENTE un array JSON. Sin explicación. Sin markdown.\n"
        "Ejemplo: [\"nunca\",\"control\",\"destruye\",\"libertad\"]"
    )
